...
function AboutPage() {
    ...
    return (
        <section className=" text-white py-10 md:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-8 md:mb-10">
                    <h1 className="italic text-4xl md:text-4xl lg:text-4xl font-semibold tracking-tight mb-2 drop-shadow-[0_12px_35px_rgba(255,255,255,0.12)]">
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative px-6 py-2.5 rounded-xl text-sm md:text-base font-medium transition-all duration-300 outline-none
                    ${isActive ? "text-white" : "text-zinc-500 hover:text-zinc-300"}`}
                                >
                                    {isActive && (
                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-zinc-800 to-zinc-700 shadow-xl border border-zinc-600/50 rounded-xl tab-active-animate"
                                        />
                                    )}
